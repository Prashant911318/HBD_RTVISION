...
static char const OTA_FILE_LOCATION[] = "http://192.167.1.2:8000/sketch_jul2b.ino.OTA.ota";
#else
...
byte mac[] = {0x00, 0x0A, 0x01, 0x1A, 0x1B, 0x1D};

IPAddress MyIp(192, 167, 1, 4);
...
void setup()
{
  ...
  int const ota_download = ota.download(OTA_FILE_LOCATION, false /* is_https */); // true for use HTTPS false for use HTTP
  if (ota_download <= 0)
  {
